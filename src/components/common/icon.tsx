...
/**
 * TODO: use a proper way to import SVG icons
 *
 * I am facing a problem when importing icons. Plasmo requires a special `react:` import
 * to load these assets, and Storybook does not support it. I tried multiple times updating
